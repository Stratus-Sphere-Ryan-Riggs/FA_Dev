...
function aftersubmit_setordernumber(stType)
{
  ...
  if(stType=='create'){
    ...
    nlapiLogExecution('DEBUG','Inside' + 'mag ref');
	var lineCount = recTrans.getLineItemCount('item');
      ...
      if((prodChannel=='Grocery' || prodChannel=='Produce' || prodChannel=='Donation')&& (magRef==null)){
    	recTrans.setLineItemValue('item','custcol_mag_ref_no',i,new Number(i*1000));
      }
  	}
  	}
