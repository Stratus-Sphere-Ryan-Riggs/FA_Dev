...
function updateRelatedRecords() {
 //   try {
      ...
      if(isReleaseDateChanged||isReqPickUpDateChanged||isPoVenCommentsChanged||isShippingMethodChanged||isMemberPONumChanged || isProjectCodeChanged || isLineQtyChanged ||isPickUpLocChanged|| isDropOffLocChanged||isLineRateChanged||isPoAdmFeeRateChanged){
      ...
      nlapiLogExecution('DEBUG', 'arrRelatedRecords=' + arrRelatedRecords );
        ...
        var fields = ['custbody_order_type','custbody_release_date','custbodycustbody_requested_pickup_date','custbodycustbody_po_vendor_comments','custbody_shipping_method_code','otherrefnum','custbody_cseg_projects_cseg'];
        ...
        var tranChanges = '';
        var transLineChange = '';
        nlapiLogExecution('DEBUG', 'Release Date', releaseDate + ' isReleaseDateChanged ' + isReleaseDateChanged+ 'Req pick up date' + reqPickupDate+ 'isReqPickUpDateChanged'+isReqPickUpDateChanged+' poComments '+poComments+ 'isMemberPONumChanged '+isMemberPONumChanged+ 'isProjectCodeChanged '+isProjectCodeChanged);
