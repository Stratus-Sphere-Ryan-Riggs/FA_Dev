...
function updateRelatedRecords() {
 //   try {
      ...
      if(isReleaseDateChanged||isReqPickUpDateChanged||isPoVenCommentsChanged||isShippingMethodChanged||isMemberPONumChanged || isLineQtyChanged ||isPickUpLocChanged|| isDropOffLocChanged||isLineRateChanged||isPoAdmFeeRateChanged){
