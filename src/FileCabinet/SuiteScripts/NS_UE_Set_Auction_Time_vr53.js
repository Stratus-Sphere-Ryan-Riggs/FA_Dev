...
newRecord.getFieldValue('status') == 'Pending Billing' ||
             newRecord.getFieldValue('status') == 'Pending Billing/Partially Fulfilled') {
                    if (newRecord.getLineItemValue('item', 'quantityfulfilled', i + 1) == 0) {
                        if (oldRecord.getLineItemValue('item', 'quantity', oldLineNum) != newRecord.getLineItemValue('item', 'quantity', newLineNum)) {
                        ...
                        if (oldRecord.getLineItemValue('item', 'custcol_drop_off_location', oldLineNum) != newRecord.getLineItemValue('item', 'custcol_drop_off_location', newLineNum)) {
                            changedObj.qtyChange = 'yes';
                            lineDropOffLocChangeDetails = lineDropOffLocChangeDetails + magRefList[i] + ':' + oldRecord.getLineItemValue('item', 'custcol_drop_off_location', oldLineNum) + ':' + newRecord.getLineItemValue('item', 'custcol_drop_off_location', newLineNum) + ':' + newRecord.getLineItemValue('item', 'custcol_vendor_item_no', newLineNum) +
                                ',';
                            recModForSync = true;
                        }
                    }
