  ...
  try
    {
        ...
        if(type == "create" && nlapiGetFieldValue('createdfrom')!=null && nlapiGetFieldValue('createdfrom')!='')
        {
          ...
          for(var i=1;i<=countItems;i++){
            ...
            if(invRec.getLineItemText('item','custcol_product_channel',i)=='Grocery' || invRec.getLineItemText('item','custcol_product_channel',i)=='Produce'){
              ...
              if (invRec.getLineItemValue('item', 'item', i) == '10629') {
                invRec.setLineItemValue('item','custcol_adjusted_amount',i,invRec.getLineItemValue('item','amount',i));
              }
      ...
      if(type == 'edit' || type == 'create') {
        ...
        for(var i=1;i<=countItems;i++){
            var itemId = invRec.getLineItemValue('item','item', i)
            ...
            if(invRec.getLineItemText('item','custcol_product_channel',i) == '' && itemId != '10629'){
