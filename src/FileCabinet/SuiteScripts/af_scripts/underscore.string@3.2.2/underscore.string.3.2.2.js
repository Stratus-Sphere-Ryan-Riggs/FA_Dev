...
// this version of underscore string is made for SS 1 Suitelets that
//can't handle the module structure of the production package
var underscore_string = function() {
	...
	return (function e( t, n, r ) {
		...
		1    : [
			...
			}, { "./camelize": 1, "./capitalize": 2, "./helper/makeString": 21 }
		], 6 : [
			function( _dereq_, module, exports ) {
				var trim = _dereq_( './trim' );
...
// for tokens requireing multitoken output
			...
			}, { "./helper/makeString": 21, "./helper/toPositive": 23 }
		], 13: [
			function( _dereq_, module, exports ) {
				var makeString = _dereq_( './helper/makeString' );
			...
			}, { "./helper/escapeChars": 18, "./helper/makeString": 21 }
		], 14: [
			function( _dereq_, module, exports ) {
...
// Copy functions to instance methods for chaining
			...
			}, { "./capitalize": 2, "./trim": 62, "./underscored": 64 }
		], 25: [
			function( _dereq_, module, exports ) {
				var makeString = _dereq_( './helper/makeString' );
			...
			}, { "./helper/defaultToWhiteSpace": 17, "./helper/makeString": 21 }
		], 34: [
			function( _dereq_, module, exports ) {
			...
			}, { "./helper/makeString": 21, "./helper/strRepeat": 22 }
		], 37: [
			function( _dereq_, module, exports ) {
			...
			}, { "./cleanDiacritics": 7, "./dasherize": 9, "./helper/defaultToWhiteSpace": 17, "./helper/makeString": 21, "./trim": 62 }
		], 46: [
			function( _dereq_, module, exports ) {
				var chars = _dereq_( './chars' );
...
// All rights reserved.
			...
			}, { "./helper/htmlEntities": 20, "./helper/makeString": 21 }
		], 66: [
			function( _dereq_, module, exports ) {
