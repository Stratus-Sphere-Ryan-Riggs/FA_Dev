...
function ui() {
    ...
    this.FormPageLinkType = uiFormPageLinkType;    
    ...
    this.SublistType = uiSublistType;    
    ...
    this.FieldBreakType = uiFieldBreakType;    
    ...
    this.FieldLayoutType = uiFieldLayoutType;    
    ...
    this.FieldDisplayType = uiFieldDisplayType;    
    ...
    this.SublistDisplayType = uiSublistDisplayType;    
    ...
    this.LayoutJustification = uiLayoutJustification;    
