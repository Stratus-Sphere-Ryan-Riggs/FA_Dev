...
//Added by thilaga for ticket #5038 starts
      ...
      if ((newRecord.getFieldValue('otherrefnum')!=null)&& (newRecord.getFieldValue('otherrefnum') !=  oldRecord.getFieldValue('otherrefnum') ))
       ...
       if ((newRecord.getFieldValue('custbody_cseg_projects_cseg')!=null)&& (newRecord.getFieldValue('custbody_cseg_projects_cseg') !=  oldRecord.getFieldValue('custbody_cseg_projects_cseg') ))
        {
           recModForSync = true;
