...
function updateRelatedRecords() {
 //   try {
  ...
  nlapiLogExecution('DEBUG', 'idSalesOrder'+'isDropOffLocChanged', JSON.stringify(isDropOffLocChanged));
      ...
      if(isReleaseDateChanged||isReqPickUpDateChanged||isPoVenCommentsChanged||isShippingMethodChanged||isMemberPONumChanged || isProjectCodeChanged || isFundChanged || isLineQtyChanged ||isPickUpLocChanged|| isDropOffLocChanged||isLineRateChanged||isPoAdmFeeRateChanged){
