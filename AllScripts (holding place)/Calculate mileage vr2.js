    ...
    if (mode == 'create' || mode == 'edit') {
        ...
        if (!seqSetByUser) {
            ...
            if (salesOrderStatus == paramOrderStatus) {
              ...
              //commented for ticket #6462 by Thilaga
              //  if (salesOrderType == paramProduce || salesOrderType == paramGrocery || salesOrderType == paramMaroon || salesOrderType == paramYellow || salesOrderType == paramDisaster) {
