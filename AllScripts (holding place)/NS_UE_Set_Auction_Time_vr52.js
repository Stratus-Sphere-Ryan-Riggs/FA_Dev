      ...
      if ((newRecord.getFieldValue('otherrefnum')!=null)&& (newRecord.getFieldValue('otherrefnum') !=  oldRecord.getFieldValue('otherrefnum') ))
	   {
        ...
        if ((newRecord.getFieldValue('status') == 'Pending Fulfillment' || newRecord.getFieldValue('status') == 'Partially Fulfilled' || newRecord.getFieldValue('status') == 'Billed') && (newRecord.getFieldValue('custbody_order_type') == '1' || newRecord.getFieldValue('custbody_order_type') == '2')) {
