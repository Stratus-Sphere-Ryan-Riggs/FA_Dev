...
function task() {
    ...
    this.MasterSelectionMode = taskMasterSelectionMode;    
    ...
    this.DedupeMode = taskDedupeMode;    
    ...
    this.DedupeEntityType = taskDedupeEntityType;    
    ...
    this.MapReduceStage = taskMapReduceStage;    
